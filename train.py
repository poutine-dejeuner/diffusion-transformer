...
def main():
    ...
    parser.add_argument('--model_dir', type=str, default=None,
                        help='Model directory. If not specified, uses output/model_i with auto-increment')
    parser.add_argument('--data_dir', type=str, default="data/photo/padded")
    ...
    # Auto-generate model directory if not specified
    if args.model_dir is None:
        args.model_dir = get_next_model_dir()
        print(f'Saving model to directory: {args.model_dir}')
    
    # Load config from YAML or Python file
    conf = load_config_from_yaml(args.config_path, args.model_dir)
    
    conf.d = args.d
    
    train(
        args.model_dir, args.fid_real_dir, 
